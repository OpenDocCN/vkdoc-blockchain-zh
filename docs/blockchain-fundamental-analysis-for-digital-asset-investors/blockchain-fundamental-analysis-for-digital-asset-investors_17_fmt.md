...
**示例：** [`Orbs Network`](https://www.orbs.com/)
...
`L3` 的一个例子是 `Orbs Network`，这是一个为广泛的链上 DeFi 应用（不仅仅是高级交易）而设计的区块链基础设施。`Orbs` 通过提供用于聚合流动性、算法和限价订单、去中心化衍生品以及其他金融模块的工具来增强 DeFi 功能。
