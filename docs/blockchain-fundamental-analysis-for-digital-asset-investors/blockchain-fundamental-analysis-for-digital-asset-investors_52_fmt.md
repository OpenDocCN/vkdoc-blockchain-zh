...
评估项目在社交媒体上的帖子，关注点不只有数量；社区参与度同样至关重要，甚至更为关键。参与度的高低取决于项目团队能否通过有意义、有影响力且高质量的内容与社区建立联系。为了了解社区的活跃程度，投资者可以评估`点赞`、`评论`、`转发`、`触及人数`和`曝光量`等指标——这些数据能让你快速了解社区的健康状况和活跃度。
...
-   每篇帖子的总互动数：151 (评论) + 480 (转发) + 823 (点赞) = 1454
-   触及人数（浏览数）= 80,400
