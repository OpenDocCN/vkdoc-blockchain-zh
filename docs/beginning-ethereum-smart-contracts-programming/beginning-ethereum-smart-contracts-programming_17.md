...
在 **编译** 选项卡中，你会看到两个代表 ABI 和字节码的图标（参见图 6-10）。如果你点击 ABI 图标，ABI 将被复制到剪贴板。

![](img/471881_2_En_6_Fig10_HTML.jpg)

截图展示了合约窗口。它显示了计算器、发布到 IPFS、发布到 Swarm、编译详情，以及被选中的 ABI 和字节码。

图 6-10

ABI 和字节码按钮提供了访问合约 ABI 和字节码的便捷途径
