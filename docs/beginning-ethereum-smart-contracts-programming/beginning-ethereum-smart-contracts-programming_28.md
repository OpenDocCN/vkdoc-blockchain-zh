...
一个显示拥有者的文本框，底部文本显示为 0 colon address colon 0 x A F 8 b 6 C A 21023 A 595 F 0 C 4919 b 8 B 4 a 9 d 1 F 0 c 1773 e 7。
...
一旦文件上传到 IPFS，你就会获得已上传到 IPFS 的图像的哈希值（称为 *内容 ID*，简称 CID）。你可以使用此哈希值在 IPFS 上获取该文件。
...
一个文本框，内容为 mint O x A F 8 b 6 C A 21023 A 595 F 0 C 4919 b 8 B 4 a 9 d 1 F 0 c 1773 e 7,1, h t t p s colon two forward slash l p f s. l o forward slash i p f s forward slash Q m f J a h E i n m 6 r Y N f s D。
...
一个文本框，显示余额为 O X A F 8 b 6 C A 21023 A 595 F 0 C 4919 b 8 B 4 a 9 d 1 F 0 c 1773 e 7，底部显示 0 colon u i n t 256 colon 1。
...
一个文本框，显示 owner 1，底部显示 ?0 colon address colon 0 x A F 8 b 6 C A 21023 A 595 F 0 C 4919 b 8 B 4 a 9 d 1 F 0 c 1773 e 7。
