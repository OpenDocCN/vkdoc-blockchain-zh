...
我们已经创建了补充这一文本的在线材料。我们的Coursera课程（[www.coursera.org/course/bitcointech](http://www.coursera.org/course/bitcointech)）包含了反映本书内容的视频讲座。它还有测验和一系列编程作业（在线资料的链接也可以在[http://press.princeton.edu/titles/10908.html](http://press.princeton.edu/titles/10908.html)找到）。参加本课程还会让你进入论坛，在那里你会找到一个志同道合的学习者社区。