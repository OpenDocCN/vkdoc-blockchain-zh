...
在法定货币中，第三种共识是仅有的共识。规则不是一致形成的——什么是一美元钞票，什么不是一美元钞票，是由法令宣布的。历史并不突出，但国家才是(例如，谁拥有什么)。状态要么由实物占有(如现金)决定，要么由专业记录人员(如银行)决定。然而，在加密货币中，规则和历史也需要达成共识。

![image](img/00080.jpeg)
