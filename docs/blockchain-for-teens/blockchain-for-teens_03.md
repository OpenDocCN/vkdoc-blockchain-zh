...
![](img/535492_1_En_1_Fig1_HTML.png)

两个中心化组织的流程图。第一个图从上到下的标签部分依次为：CEO、工程经理、市场经理、工程师和市场人员。第二个图标记为“中心化”，箭头从中央结构向外指向各方。
...
![](img/535492_1_En_1_Fig2_HTML.png)

两个区块链图展示了在市场和工程部门下的去中心化组织。标记的流程位置依次为：CEO、经理、工程师和市场人员。
...
![](img/535492_1_En_1_Fig3_HTML.png)

一个带有标注特征的区块链流程图。标注的链条流向包括：去中心化、不可篡改性、安全性、透明性和共识。
...
![](img/535492_1_En_1_Fig4_HTML.png)

从区块 1 到区块 n（分别记作 T1 至 Tn）的区块链示意图，包含第 3、4、5 日以及今日。
...
![](img/535492_1_En_1_Fig5_HTML.png)

区块示意图包含头部和主体。头部的标注部分为：版本号、前一个区块哈希、时间戳、nBits、Nonce（随机数）、Merkle 根（默克尔根）。主体部分标记有“交易”以及一个标记为“交易计数器”的方框。
...
![树数据结构](img/535492_1_En_1_Fig6_HTML.jpg)
...
![梅克尔树哈希计算](img/535492_1_En_1_Fig7_HTML.png)
...
![包含梅克尔树和前一个区块哈希的区块序列](img/535492_1_En_1_Fig8_HTML.png)

*图 1-8：包含梅克尔树和前一个区块哈希的区块序列*
...
![](img/535492_1_En_1_Fig13_HTML.png)
...
![](img/535492_1_En_1_Fig14_HTML.png)
...
`NFC`，即近场通信，是一种允许移动设备通过私密通道安全连接的技术。通常要求设备之间保持较短距离（4 厘米或更短）才能建立连接。  
移动设备通过`NFC`标签与使用`NFC`的商家建立连接。客户需要激活`NFC`才能开始一对一的交互。

**二维码支付**  
快速响应码，即二维码，是一种二维条码。它编码了信息，以便商品可以当场购买。手机等数字设备可以读取这些信息。  
许多移动钱包支持二维码支付，例如`PayPal`、`Zelle`、`Square`和`Venmo`。
...
![](img/535492_1_En_1_Fig15_HTML.png)
...
金融市场中的`波动性`是指资产价格在特定时期内上涨或下跌的速率。它是理解、管理和量化投资风险的重要指标。通常，高波动性指价格快速波动，而低波动性指价格在小范围内缓慢变化，意味着价格相对稳定。

高波动性通常意味着更高的风险，但也可能带来更高的回报。而低波动性通常意味着较低的风险和较低的回报，但这并非绝对。低波动性的一个例子是政府债券，它们完全由政府信用背书，通常被市场视为低风险资产。黄金是另一个例子，因其价格长期保持稳定。图 1-18 展示了高波动性与低波动性。

![](img/535492_1_En_1_Fig18_HTML.jpg)

*一张关于时间与价格的示意图，高波动性表现为大幅震荡的锯齿线，低波动性表现为小幅震荡的锯齿线。*

**图 1-18** *高波动性与低波动性*

许多人听说过加密货币市场的高波动性。一些加密货币的价格可能在极短时间内暴跌 90%。让我们来看几个例子。

市场回调通常指从近期最高点下跌 10% 到 20%。表 1-4 列出了从 2013 年 11 月到 2020 年 3 月比特币回调的历史记录。对于加密货币新手来说，加密市场的崩盘可能相当可怕。然而，对于那些了解比特币历史的人来说，这种市场回调并不新鲜。尽管这些下跌让人们对比特币不稳定的价格感到相当沮丧，但其价格从 2010 年的`0.0008 美元`起步，随着时间的推移，在 2022 年 6 月上涨到了`25000 美元`。

**表 1-4** *比特币回调历史*

| 日期 | 价格 | 跌幅 |
| --- | --- | --- |
| 2013 年 11 月 30 日–2016 年 1 月 14 日 | 1163 美元 - 152 美元 | -86.9% |
| 2017 年 3 月 10 日–25 日 | 1350 美元–891 美元 | -34.0% |
| 2017 年 5 月 25 日–27 日 | 2760 美元–1850 美元 | -33.0% |
| 2017 年 6 月 12 日–7 月 17 日 | 2980 美元–1830 美元 | -38.6% |
| 2017 年 9 月 2 日–15 日 | 4980 美元–2972 美元 | -40.3% |
| 2017 年 11 月 8 日–12 日 | 7888 美元– 5555 美元 | -29.6% |
| 2017 年 12 月 17 日–2018 年 12 月 15 日 | 19666 美元–3220 美元 | -83.6% |
| 2019 年 6 月 26 日–2020 年 3 月 12 日 | 12867 美元– 5040 美元 | -60.8% |

`Luna`（也称为`Terra`）是最初`Terra`区块链的原生代币，该区块链于 2018 年启动。当时，该代币的名称为`LUNA`。`Luna`是韩国公司`Terraform Labs`于 2018 年开发的一条区块链。该区块链旨在改造现代金融体系。

2020 年，`Luna`开始出售名为`TerraUSD`的稳定币。`Luna`曾是市值排名前十的主要加密货币。但根据`CoinMarketCap`的数据，2022 年 5 月 11 日，`LUNA`在 24 小时内跌至原价的 2%。`LUNA`的价格在一天内从`32.71 美元`跌至`0.08384 美元`。

![](img/535492_1_En_1_Fig19_HTML.jpg)

*一张 Luna 市场价格波动示意图，其价值从 190.52719716、119.2518039、46.12450969、0.80000000 跌至 0.00007500。*

**图 1-19** *加密货币市场波动性——Luna*

`StepN`是一款“边运动边赚钱”的健身应用，引入了一种新的`Web3`生活方式应用。用户必须购买`NFT`运动鞋才能参与游戏。`STEPN`使用`GST`（`Green Satoshi Token`），这是一种基于`Solana`区块链的代币。用户可以通过在户外步行或跑步，利用手机`GPS`服务追踪用户运动轨迹来赚取`GST`，或者通过将自己的`NFT`运动鞋“出租”给其他用户来赚取代币。其中一些运动鞋在`NFT`市场上价值数千美元。`StepN`由`FindSatoshi Lab`于 2021 年 12 月推出。这一创新方案使`STEPN`迅速颠覆了健身行业，并获得了市场的广泛关注。

加密货币市场于 2022 年 3 月 9 日开始上线`GMT(STEPN)`。起初价格为`0.01 美元`。到 4 月 28 日，价格飙升至`4.03 美元`——短短 51 天内涨幅达 40200%（数据来自`coinmarketcap`）。但在整个加密货币市场下跌之后，其价格在 2022 年 6 月跌至`0.6317 美元`。图 1-20 展示了加密货币市场的波动性——`STEPN`。该图表来自`CoinGecko`。

![](img/535492_1_En_1_Fig20_HTML.png)

*一张来自 CoinGecko 的加密货币市场波动性示意图。5 月 2 日的最高波峰高于 5400。*

**图 1-20** *加密货币市场波动性——Stepn（来自 CoinGecko）*
