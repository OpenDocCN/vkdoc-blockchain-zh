...
![图 8-1 研究发表背景下阳性与阴性数据概述](img/430562_2_En_8_Fig1_HTML.jpg)
...
更多知名期刊增加了数据共享声明，以说明数据集将在何处提供以及共享何种类型的数据。例如，`Cell Press` 创办了一份新期刊，用于发表经过同行评审、具有可重复性且方法透明的研究成果，名为 `STAR protocols`。同样，`EQUATOR` 网络也为科学报告中发表的数据制定了关于质量标准的结构化指南。
...
![图 8-2 铸币者与持有者之间的互动](img/430562_2_En_8_Fig2_HTML.jpg)
...
![图 8-3 区块链接入到临床试验工作流程的总结](img/430562_2_En_8_Fig3_HTML.jpg)
