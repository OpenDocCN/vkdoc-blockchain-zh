...
```python
task_1 = asyncio.create_task(greet(1))
task_2 = asyncio.create_task(greet(2))
task_3 = asyncio.create_task(greet(2))
```
...
![一个节点首次加入网络](img/475256_1_En_5_Fig3_HTML.jpg)
...
![并排的两个终端，模拟两个用户互相聊天](img/475256_1_En_5_Fig2_HTML.jpg)
