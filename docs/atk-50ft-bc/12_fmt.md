...
作为一篇对区块链非常积极的论文，TechUK 的《银行和金融服务中分布式账本技术的工业化》写道:^(368)：

> 目前还没有经过企业级容量、安全性、可靠性和法规测试的商业成熟技术平台。这是阻碍用例高效实现的关键因素之一。迄今为止，为了进行 POC，银行已经使用了可用的开源或供应商技术。在 POC 阶段可以做出一些妥协或假设，但这些不能用于生产系统。
...
特别是在金融业，后台系统已经有几十年的历史了，如果不付出巨大的努力就无法实现互操作。尽管在计算机化方面付出了相当大的努力，但仍然有太多的纸张和人力。和解仍然需要几天时间。华尔街非常容易接受区块链的推销。 ^(370)
...
*   **保险软件**: 布莱姆信息管理公司设想将所有文件放在一个区块链上，这样`智能合约`可以加快支付速度。这份声明要解决的问题是保险公司故意篡改或丢失文件:“人们一直怀疑保险公司可能会改变过去情况的数据。”^(371) 它没有解释一个准备公然欺诈的保险公司怎么会被信任支付赔款。评估索赔实际上是最难的部分，索赔调整是通过人与人之间的对话来完成的。该提案使用`智能合约`来加快处理索赔——这只是将所有后台计算从保险公司转移到有问题的区块链的矿工身上。
*   **土地所有权登记**: 区块链的土地所有权登记没有解决土地所有权登记的实际问题:有所有者但没有被列入现有官方登记册的地块。将官方登记册储存在区块链上并不比储存在普通数据库(你已经可以分发经认证的副本)中有优势，而且没有数字记录会强制你使用土地。
*   **供应链起源**: 供应链起源是一个长期的提议。出处公司提议在以太坊区块链放置金枪鱼捕获量。他们声称向所有参与者提供供应链透明度，这将揭露涉及侵犯人权的非法过度捕捞或捕捞。数据仍将由当地人输入，由“可信的”当地非政府组织赞助，这些组织每月支付软件费用。人们的假设似乎是，从事非法过度捕捞或侵犯人权的商业活动会仔细记录他们在区块链的非法活动，而不仅仅是撒谎，或者贿赂“中立”的检查员或裁判——就像当前供应链监控中发生的那样。^(373) 主要副产品是对追溯提供者的垄断，*即*，出处。他们自己的白皮书同时声称，该系统是“分散的”，但有一个集中控制的“来源验证监管链”。实际上，现在的问题是在收集什么数据或如何处理这些数据的问题上没有达成一致。
*   **音乐产业**: 几乎所有被提议的音乐产业案例(见下一章)。
*   **甲骨文问题**: 这也有一个“甲骨文问题”的快速案例:首先，将真实世界的好数据输入区块链需要人类的判断。
*   **(其他)**: (一些区块链炒作谈论“区块链的人工智能”如果有人尝试这一种，深入了解他们的人工智能产品的细节。)
...
终于获得资金来清理你的数据和格式，也许值得说一句“区块链”来自*彭博*的马特·莱文指出:“‘区块链’这个词让枯燥的后台协调工作变得性感起来，这意味着它可能真的会完成。” ^(375) 这一点，而不是区块链自己提出的任何东西，似乎是迄今为止商业区块链试验最富有成效的结果。一旦这样做了，你就可以通过去掉区块链来显著提高效率。
...
1.  他们是不是混淆了“可能”和“是”？(*几乎所有区块链宣称的商业都充满了“可能”，销售人员谈论着“可能性”)他们有没有今天还在工作的区块链，做着他们声称你能从区块链那里得到的每一件事情？如果没有，缺少哪些？*
2.  系统会根据您的数据规模进行扩展吗？怎么会？
3.  在“不变的”区块链或`智能合约`中，你如何处理人为错误？
4.  如果这是为了与你不信任的人合作，而不是与你现在打交道的人合作，那么他们如何确保供应链的安全——安全威胁模型是什么？(让您的系统管理员一起提出尖锐的问题。)
5.  如果是为了和你已经信任到那种程度的人一起工作，你为什么还要麻烦一个区块链呢？
6.  这给你带来了集中式数据库所不能带来的什么？具体怎么做？(向下钻取。)
7.  If it’s for working with people you can already trust to that degree, why are you bothering with a blockchain?
8.  安全威胁模型
