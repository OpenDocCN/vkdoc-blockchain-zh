...
图 4-17：例如亚马逊 Alexa 所使用的自然语言处理的五个基本步骤
...
图 4-18 通用的药物发现流程，显示了不同阶段通常所需的时间和资金。人工智能 (AI) 能够通过协助先导物选择和优化阶段来减少时间和成本。
