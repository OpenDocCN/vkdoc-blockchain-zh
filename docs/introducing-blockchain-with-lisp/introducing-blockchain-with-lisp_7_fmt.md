...
![../images/510363_1_En_3_Chapter/510363_1_En_3_Figb_HTML.gif](img/510363_1_En_3_Figb_HTML.gif)
定义 3-1
...
![../images/510363_1_En_3_Chapter/510363_1_En_3_Figc_HTML.gif](img/510363_1_En_3_Figc_HTML.gif)
定义 3-2
...
![../images/510363_1_En_3_Chapter/510363_1_En_3_Figd_HTML.gif](img/510363_1_En_3_Figd_HTML.gif)
练习 3-1
使用 `make-wallet` 创建一个钱包，并通过 `define` 将其存储在一个变量中。

![../images/510363_1_En_3_Chapter/510363_1_En_3_Fige_HTML.gif](img/510363_1_En_3_Fige_HTML.gif)
练习 3-2
提取之前创建的钱包的私钥和公钥。代码应类似于 `(wallet-?? (make-wallet))`。

![../images/510363_1_En_3_Chapter/510363_1_En_3_Figf_HTML.gif](img/510363_1_En_3_Figf_HTML.gif)
练习 3-3
...
```
> (struct block
  (current-hash previous-hash data timestamp)
  #:prefab)
```
...
'#s(block "123456" "234" #s(transaction "BoroS" "Boro" "You" 123)
    1 1)
```
