...
> 1212
列表 8-18
使用 Geth 的 puppeth 配置向导为 id 为 1212 的 PoA 网络设置创世区块的片段。完成上述步骤后，你将得到一个新的 mysidechain.json 创世文件。
```
