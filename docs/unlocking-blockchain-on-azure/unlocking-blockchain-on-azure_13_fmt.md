...
![图 3-2](img/474923_1_En_3_Fig2_HTML.jpg)

图 3-2 在 `Python` 中使用 `SECP256k1`

1.  我们使用了 `Azure Jupyter notebook` 来实现以下内容（图 3-1）。

![图 3-1](img/474923_1_En_3_Fig1_HTML.jpg)

图 3-1 在 `Python` 中实现 `SHA256` 加密
...
![图 3-3](img/474923_1_En_3_Fig3_HTML.jpg)

图 3-3 基于活跃用户数、趋势、价值等排名的前八大 `DApp`
...
![图 3-4](img/474923_1_En_3_Fig4_HTML.png)

图 3-4 中心化环境下的贸易金融流程及其问题