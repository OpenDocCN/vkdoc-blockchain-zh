...
![图9-1 硬实时系统与软实时系统](img/520777_1_En_9_Fig1_HTML.jpg)
...
![图9-2 状态事件](img/520777_1_En_9_Fig2_HTML.jpg)
...
![图9-3 与实时数据相关的时间参数](img/520777_1_En_9_Fig3_HTML.jpg)
...
5. 答案：正确。实时系统模型的主要部分是`工作负载模型`、`资源模型`和`算法`。
