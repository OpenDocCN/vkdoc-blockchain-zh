...
接下来，您将收到一条消息，其中包含一个链接：您的实例正在启动。已启动以下实例： [实例 id]。
...
你也可以通过访问包含全节点的服务并检查钱包余额，在线确认该钱包的交易。图 2-25 显示了来自 [`https://bitref.com/1Mr2G632PfQuq4uJXRBNWLoRKH71Qwor51`](https://bitref.com/1Mr2G632PfQuq4uJXRBNWLoRKH71Qwor51) 的截图。
