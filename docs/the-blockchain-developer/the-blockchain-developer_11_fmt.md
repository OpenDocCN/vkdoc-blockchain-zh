...
就这样。你保持了基础和简单，只有一个事件和一个函数。你可以从这里下载这一步的代码：[`https://github.com/Apress/the-blockchain-developer/chapter10/step1.zip`](https://github.com/Apress/the-blockchain-developer/chapter10/step1.zip)。
